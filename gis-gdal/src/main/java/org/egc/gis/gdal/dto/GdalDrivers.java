...
public enum GdalDrivers {
    ...
    HDF4("HDF4", "raster", "ros", "Hierarchical Data Format Release 4","h4"),
    HDF4Image("HDF4Image", "raster", "read, write and update", "HDF4 Dataset",""),
    HDF5("HDF5", "raster", "ros", "Hierarchical Data Format Release 5","h5"),
    ...
    NITF("NITF", "raster", "read, write and update, supporting virtual IO and subdatasets", "National Imagery Transmission Format","ntf"),
    ...
    BMP("BMP", "raster", "read, write and update, supporting virtual IO", "MS Windows Device Independent Bitmap","bmp"),
    ...
    WMTS("WMTS", "raster", "rwv", "OGC Web Mab Tile Service","xml"),
    ...
    NTv2("NTv2", "raster", "read, write and update, supporting virtual IO and subdatasets", "NTv2 Datum Grid Shift","gsb"),
    ...
    ADRG("ADRG", "raster", "read, write and update, supporting virtual IO and subdatasets", "ARC Digitized Raster Graphics","gen/thf"),
    ...
    ESRI_Shapefile("ESRI Shapefile", "vector", "read, write and update, supporting virtual IO", "ESRI Shapefile","shp"),
    ...
    GdalDrivers(String name, String readOrWrite, String type, String description, String extension) {
        this.name = name;
        this.type = type;
