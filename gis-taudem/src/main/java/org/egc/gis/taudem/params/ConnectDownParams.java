...
public class ConnectDownParams implements Params {
    ...
    public String getOutput_Outlets_file() {
        if (StringUtils.isBlank(Output_Outlets_file)) {
            return FilenameUtils.normalize(
                    outputDir + File.separator + namingOutput(Input_D8_Flow_Direction_Grid, "Output_Outlets_file",
                                                              "File", null));
        }
    ...
    public String getOutput_MovedOutlets_file() {
        if (StringUtils.isBlank(Output_MovedOutlets_file)) {
            return FilenameUtils.normalize(
                    outputDir + File.separator + namingOutput(Input_D8_Flow_Direction_Grid, "Output_MovedOutlets_file",
                                                              "File", null));
        }
